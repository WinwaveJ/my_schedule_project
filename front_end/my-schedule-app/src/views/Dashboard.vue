          ...
          <div class="quadrant-container">
            <div class="quadrant">
              ...
              <div 
                class="task-grid"
                @dragover.prevent
                @drop="handleDrop($event, 'URGENT_IMPORTANT')"
              >
                <div 
                  v-for="task in urgentImportantTasks" 
                  :key="task.id" 
                  class="task-box urgent-important"
                  :class="{ 'overdue-task': task.status === 'OVERDUE' }"
                  draggable="true"
            ...
            <div class="quadrant">
              ...
              <div 
                class="task-grid"
                @dragover.prevent
                @drop="handleDrop($event, 'NOT_URGENT_IMPORTANT')"
              >
                <div 
                  v-for="task in importantNotUrgentTasks" 
                  :key="task.id" 
            ...
            <div class="quadrant">
              ...
              <div 
                class="task-grid"
                @dragover.prevent
                @drop="handleDrop($event, 'URGENT_NOT_IMPORTANT')"
              >
                <div 
